...
import com.java.lmsdb.dao.EmployDao;
import com.java.lmsdb.dao.EmployDaoImpl;
import com.java.lmsdb.dao.LeaveDao;
import com.java.lmsdb.dao.LeaveDaoImpl;
...
public class LeaveBal {
	...
	public String changeLeaveStatusDaoBal(int empAsManagerId, int leaveId,LeaveStatus status,String comments) throws ClassNotFoundException, SQLException
	{
